...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240402171005_fixGenreTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Entitys.Actor", b =>
                {
            ...
            modelBuilder.Entity("MovieActor", b =>
                {
                    ...
                    b.HasIndex(new[] { "MovieId" }, "MOVIEACTOR2_FK");

                    b.HasIndex(new[] { "ActorId" }, "MOVIEACTOR_FK");
            ...
            modelBuilder.Entity("MovieGenre", b =>
                {
                    ...
                    b.HasIndex(new[] { "MovieId" }, "MOVIEGENRE2_FK");

                    b.HasIndex(new[] { "GenreId" }, "MOVIEGENRE_FK");

                    b.ToTable("MovieGenre", (string)null);
                });

            modelBuilder.Entity("Model.Entitys.User", b =>
                {
            ...
            modelBuilder.Entity("Model.Entitys.Rating", b =>
                {
                    ...
                    b.HasOne("Model.Entitys.User", "User")
                        .WithMany("Ratings")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MovieActor", b =>
                {
                    b.HasOne("Model.Entitys.Actor", null)
                        .WithMany()
                    ...
                    b.HasOne("Model.Entitys.Movie", null)
                        .WithMany()
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
